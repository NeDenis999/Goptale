...
public class ButtonManagerBattleMenu : ButtonManagerBase
{
    ...
    private IEnumerator Switching(int count = 0)
    {
        if (_isActive)
        {
            ...
            {
                button.GetComponentsInChildren<Image>()[0].color = new Color32(255, 130, 41, 255);
                button.GetComponentsInChildren<Image>()[1].color = new Color32(255, 130, 41, 255);
                button.GetComponentInChildren<TextMeshProUGUI>().color = new Color32(255, 130, 41, 255);
                //print(button.GetComponentsInChildren<TextMeshProUGUI>());
            }

            _buttons[_activeCountButton].GetComponentsInChildren<Image>()[0].color = new Color32(255, 255, 0, 255);
            _buttons[_activeCountButton].GetComponentsInChildren<Image>()[1].color = new Color32(255, 255, 0, 0);
            _buttons[_activeCountButton].GetComponentInChildren<TextMeshProUGUI>().color = new Color32(255, 255, 0, 255);
